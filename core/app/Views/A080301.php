          ...
          <div class="card ">
            ...
            <form id="page_form" role="form" class="form-horizontal">
              ...
              <div class="alert alert-info alert-dismissible">
                  ...
                  Isikan data berikut terlebih dahulu, dan Klik <strong>Save</strong>untuk menyimpan.<br>Kemudian jika mengarsipkan surat pilih button <strong>Arsipkan</strong> atau mengajukan surat pilih button <strong>Ajukan</strong>. Harap diisikan data dengan informasi yang selengkap-lengkapnya.
                </div>
                <div class="row">
