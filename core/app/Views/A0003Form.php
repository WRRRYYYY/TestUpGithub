...
//						$NamaInstansi = $oRS->NamaInstansi;	
  ...
  <div class="content-wrapper">
    ...
    <?php 	
                          ...
                          <div class="form-group row">
                              <label for="Instansi" class="col-sm-3 control-label">Bidang/Bagian</label>
                              <div class="col-sm-9">
                                <select class="form-control select2 editable-combo" name="Instansi" id="Instansi" data-placeholder="Pilih Bidang/Bagian" style="width: 100%;"<?php if($KodeInstansi=="") { ?> disabled="disabled"<?php } ?>>
                                    <option value=""></option><?php 	
        if(isset($oQueryBidang)) {
            if(count($oQueryBidang) > 0) {
                foreach($oQueryBidang as $oRS) {
                    $sSelected = "";
                    if($KodeInstansi==$oRS->Kode) $sSelected = " selected=\"selected\""; ?>
                                    <option value="<?php echo $oRS->Kode ?>"<?php echo $sSelected ?>><?php echo $oRS->Nama ?></option>
    <?php 	
                }
            }
