...
// Biar langsung tampil kalau value-nya udah keisi dari backend (mode edit)
$('#KodeHeader').trigger('change');
    												...
    												if (arResp[2].indexOf("<!--##-->") > 0) {
    													...
    													setTimeout(function() {
    														...
    														if ($('#image').cropper('getData').height > 0) {
    															...
    															//	Swal.close();
    															Swal.close();
																if(arResp[1].indexOf("Tapi Anda belum")>1) {
    																Swal.fire({
    																		title: "Success",
    																		text: arResp[1],
    																		icon: "success",
																	...
																	Swal.fire({
																		...
																		showCancelButton: true,
																		// showDenyButton: true,
																		confirmButtonText: "Ajukan Asman",
