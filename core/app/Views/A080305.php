            ...
            <tbody>
              ...
              ?>
                    <tr>
                      ...
                      <td><a href="<?php echo  base_url() . "/" . strtolower($controller_name) . "/mnu/" . substr(md5(rand()), 4, 7) . "/salt/" . $mnu . $url_add ?>" class="nav-edit"><?php echo $oRS->TanggalSurat ?></a></td>
                      ...
                      <td style="width:40px; text-align:center">
                        <div class="btn-group">
                          <a href="<?php echo  base_url() . "/" . strtolower($controller_name) . "/mnu/" . substr(md5(rand()), 4, 7) . "/salt/" . $mnu . $url_add ?>" class="btn btn-xs btn-info control-view" title="Lihat Data"><i class="fas fa-search "></i></a>
