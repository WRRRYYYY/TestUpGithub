            ...
            <tbody>
              ...
              ?>
                    <tr>
                      ...
                      <td><span class="badge badge-warning" ><?php echo $oRS->NamaLokasi  ?></span></td>
                      <td style="width:40px; text-align:center">
                        <div class="btn-group" role="group" aria-label="Action Button">
                          <a href="<?php echo  base_url() . "/" . strtolower($controller_name) . "/mnu/" . substr(md5(rand()), 4, 7) . "/salt/" . $mnu . $url_add ?>" class="btn btn-xs btn-info control-view" title="Lihat Data"><i class="fas fa-edit small"></i></a>
                        </div>
                      </td>
                    </tr><?php
                        }
