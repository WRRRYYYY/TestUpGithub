  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-dark">Form Verifikasi</h1>
          </div><!-- /.col -->
            ...
            <form id="page_form" role="form" class="form-horizontal">
              ...
              <div class="card-body">
                <div class="alert alert-info alert-dismissible">
                  ...
                  Berikut adalah data surat yang perlu Anda verifikasi.<br>Silahkan diperiksa dan diubah jika ada yang perlu untuk disesuaikan.
                </div>
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="row bg-success">
                      <label for="Verif" class="col-sm-2 control-label">Status </label>
                      <div class="col-10">
                        <div class="mt-2">
                            <div class="icheck-primary d-inline">
                                <input type="checkbox" id="Verif" name="Verif" class="form-control"<?php if($EditDisabled=="1") {  ?> disabled="disabled"<?php } ?> value="1" title="Draf" <?php if($Verif=="1") { echo " checked=\"checked\""; } ?>>
                                <?php if($EditDisabled=="1") {  ?>
                                <label for="Verif"> Diverifikasi <small class="text-danger">(sudah terverifikasi)</small></label>
                                <?php } else {  ?>
                                <label for="Verif"> Diverifikasi <small class="text-danger">(dicek/centang jika ingin langsung diverifikasi)</small></label>
                                <?php }  ?>
                            </div>
                        </div>
                      </div>
