                    ...
                    <tr>
                      <td style="width:40px; text-align:center">
                        <div class="btn-group" role="group" aria-label="Action Button">
                          ...
                          <a href="<?php echo $oRS->idx; ?>" class="btn btn-xs btn-danger control-delete" title="Hapus Data"><i class="fas fa-trash-alt"></i></a>
                        </div>
                      </td>
                     
                      <td><a href="<?php echo  base_url() . "/" . strtolower($controller_name) . "/mnu/" . substr(md5(rand()), 4, 7) . "/salt/" . $mnu . $url_add ?>" class="nav-edit"><?php echo $AppClass->date_format_ina($oRS->TglArsip) ?></a></td>
                      <td><a href="<?php echo  base_url() . "/" . strtolower($controller_name) . "/mnu/" . substr(md5(rand()), 4, 7) . "/salt/" . $mnu . $url_add ?>" class="nav-edit"><?php echo $oRS->NomorSurat ?></a></td>
                      <td><a href="<?php echo  base_url() . "/" . strtolower($controller_name) . "/mnu/" . substr(md5(rand()), 4, 7) . "/salt/" . $mnu . $url_add ?>" class="nav-edit"><?php echo $oRS->TglSurat ?></a></td>
                      <td><a href="<?php echo  base_url() . "/" . strtolower($controller_name) . "/mnu/" . substr(md5(rand()), 4, 7) . "/salt/" . $mnu . $url_add ?>" class="nav-edit"><?php echo $oRS->Pengirim ?></a></td>
                      <td><a href="<?php echo  base_url() . "/" . strtolower($controller_name) . "/mnu/" . substr(md5(rand()), 4, 7) . "/salt/" . $mnu . $url_add ?>" class="nav-edit"><?php echo $oRS->Perihal ?></a></td>
