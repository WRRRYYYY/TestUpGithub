            ...
            <tbody>
              ...
              ?>
                    <tr>
                      ...
                      <td><?php
                        $i = 0;
                        foreach(explode(",",$oRS->DispoKeSeries) as $DispoKe) {
                            if($i % 3 == 0) echo "<span class=\"badge badge-success\">".$DispoKe."</span> ";
                            elseif($i % 3 == 1) echo "<span class=\"badge badge-warning\">".$DispoKe."</span> "; 
                            elseif($i % 3 == 2) echo "<span class=\"badge badge-danger\">".$DispoKe."</span> ";
                            $i++;
                        }
                      //echo $oRS->DispoKeSeries  ?></td>
                      <td class="text-center" style="width:40px">
                        <div class="btn-group" role="group" aria-label="Action Button">
                          <a href="<?php echo  base_url() . "/" . strtolower($controller_name) . "/mnu/" . substr(md5(rand()), 4, 7) . "/salt/" . $mnu . $url_add ?>" data-idx="<?php echo $oRS->idx ?>" class="btn btn-xs btn-danger control-undo" title="Batalkan Pengajuan"><i class="fa fa-undo-alt"></i></a>
                        </div>
                      </td>
                    </tr><?php
                        }
