              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                      <input type="text" class="form-control text-center" name="Seq" id="Seq" value="<?php echo $Seq ?>" placeholder="Seq">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="Teks" class="col-sm-2 control-label">Isi Surat</label>
                    <div class="col-sm-10">
                      <div data-name="Teks" class="form-control inline-editor"><?php echo $Teks ?></div>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="optAktif_1" class="col-sm-2 col-form-label">Status</label>
