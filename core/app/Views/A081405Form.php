  ...
  if (isset($oQuery)) {
    if (count($oQuery) > 0) {
      foreach ($oQuery as $oRS) {
        ...
        $AsmanOleh = $oRS->AsmanOleh;
        $AsmanCatatan = $oRS->AsmanCatatan;
            ...
            <form id="page_form" role="form" class="form-horizontal">
              ...
              <div class="card-body">
                <div class="alert alert-info alert-dismissible">
                  ...
                  Form ini digunakan untuk mengajukan surat yang sudah Anda verifikasi kepada atasan untuk diperiksa dan ditandatangani.<br>
                  Silahkan Anda tentukan siapa seharusnya yang menandatangani surat ini.
                </div>
                <div class="row">
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group row">
                      <label for="AsmanOleh" class="col-sm-2 control-label">Diajukan Kepada</label>
                      <div class="col-sm-10">
                        <select class="form-control select2 editable-combo" name="AsmanOleh" id="AsmanOleh" data-placeholder="Pilih Pejabat Penandatangan" required="required" data-validate="1" style="width: 100%;">
                          <option value=""></option>
                          <?php
                          if (isset($oQueryAsmanOleh)) {
                            if (count($oQueryAsmanOleh) > 0) {
                              foreach ($oQueryAsmanOleh as $oRS) {
                                if($oRS->Kode."," != $KodePosisiUser.",") {
                                  $sSelected = "";
                                  if (".".$AsmanOleh."," == ".".$oRS->Kode.",") $sSelected = " selected=\"selected\""; ?>
                    ...
                    <div class="form-group row mb-2">
                      <label for="AsmanCatatan" class="col-sm-2 control-label">Catatan</label>
                      <div class="col-sm-10">
                        <textarea class="form-control" name="AsmanCatatan" id="AsmanCatatan" placeholder="Catatan Pengajuan Asman" style="height: 150px;"><?php echo $AsmanCatatan ?></textarea>
                      </div>
                    </div>
