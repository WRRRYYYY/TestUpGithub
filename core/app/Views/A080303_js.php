<script src="<?php echo base_url() ?>/plugins/select2/dist/js/select2.full.min.js" type="text/javascript"></script>
    <!-- DataTables -->
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#datatable").on("click", "a.control-print", function(e) {
			e.preventDefault();
			var btn = $(this);
			Swal.fire({
				title: "<span style='color:#dc3545'>Anda yakin?</span>",
