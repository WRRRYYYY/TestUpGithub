            ...
            <form id="page_form" role="form" class="form-horizontal">
              ...
              <div class="card-body">
                <div class="alert alert-info alert-dismissible">
                  ...
                  Untuk Proses Disposisi, pilih bagian/bidang yang ditunjuk pada isian Diteruskan Kepada.
                </div>
                <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control select2 editable-combo" name="AjukanCC" id="AjukanCC" class="select2 form-control" multiple="multiple" data-placeholder="Pilih Pejabat yang mengetahui" style="width: 100%;" disabled="disabled">
                          <!-- <option value=""></option> -->
                          <?php
                    ...
                    <div class="form-group row">
                      <label for="AjukanCaption" class="col-sm-2 control-label">Permohonan Arahan</label>
                      <div class="col-sm-10">
                        <select class="form-control select2 editable-combo" name="AjukanCaption" id="AjukanCaption" class="select2 form-control" multiple="multiple" data-placeholder="Permohonan Arahan" style="width: 100%;" disabled="disabled">
                          <!-- <option value=""></option> -->
                          <?php
                    ...
                    <div class="form-group row">
                      <label for="AjukanCatatan" class="col-sm-2 control-label label-data">Catatan</label>
                      <div class="col-sm-8">
                        ...
                        <div class="accordion" id="timelineAccordion">
                          <div class="card">
                            ...
                            <div id="collapseTimeline" class="collapse" aria-labelledby="headingOne" data-parent="#timelineAccordion">
                              <div class="card-body">
                                <?php if (!empty($DokumenPath)) : ?>
                                  <iframe src="<?php echo $DokumenPath ?>" title="Preview" style="width:100%; height:1000px;"></iframe>
                                <?php else : ?>
                    ...
                    <div class="form-group row">
                      <label for="DispoKe" class="col-sm-2 control-label">Diteruskan Kepada</label>
                      <div class="col-sm-10">
                      <select class="form-control select2 editable-combo" name="DispoKe" id="DispoKe" class="select2 form-control" multiple="multiple" data-placeholder="Pilih Tujuan Disposisi " style="width: 100%;">
                          <!-- <option value=""></option> -->
                          <?php
                    ...
                    <div class="form-group row">
                      <label for="DispoTanggal" class="col-sm-2 control-label">Tanggal Disposisi</label>
                      <div class="col-sm-2">
                        <div class="input-group date" id="paramdate2" data-target-input="nearest">
                          <input id="DispoTanggal" name="DispoTanggal" type="text" class="form-control datetimepicker-input text-center" data-target="#paramdate2" value="<?php echo $DispoTanggal ?>" />
                    ...
                    <div class="form-group row">
                      <label for="DispoCaption" class="col-sm-2 control-label">Arahan Disposisi</label>
                      <div class="col-sm-10">
                        <select class="form-control select2 editable-combo" name="DispoCaption" id="DispoCaption" class="select2 form-control" multiple="multiple" data-placeholder="Pilih Arahan Disposisi" style="width: 100%;">
                          <option value=""></option>
                          <?php
                          if (isset($oQueryDispoCaption)) {
                            if (count($oQueryDispoCaption) > 0) {
                              foreach ($oQueryDispoCaption as $oRS) {
                                $sSelected = "";
                                if ($DispoCaption == $oRS->Kode) $sSelected = " selected=\"selected\""; ?>
                                <option value="<?php echo $oRS->Kode ?>" <?php echo $sSelected ?>><?php echo $oRS->Nama ?></option>
                          <?php
                              }
                            }
                    ...
                    <div class="form-group row mb-2">
                      <label for="DispoCatatan" class="col-sm-2 control-label">Catatan</label>
                      <div class="col-sm-10">
                        <textarea class="form-control" name="DispoCatatan" id="DispoCatatan" placeholder="Catatan Pengajuan" style="height: 150px;"><?php echo $DispoCatatan ?></textarea>
                        <div class="form-group mt-2">
                          <label><input type="checkbox" name="kirimNotif" id="kirimNotif" > Kirim notifikasi WhatsApp</label>
                        </div>
                      </div>
                    </div>
