            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-10">
                  ...
                  <div class="form-group row">
                    <label for="Kelompok" class="col-sm-3 control-label">Kelompok Surat</label>
                    <div class="col-sm-2">
                      <select class="form-control select2 editable-combo" name="Kelompok" id="Kelompok" data-validate="1">
                        <option value="">Pilih Kelompok Surat</option>
                        <option value="SM" <?php echo ($Kelompok == 'SM') ? 'selected="selected"' : ''; ?>>Surat Masuk</option>
                        <option value="SK" <?php echo ($Kelompok == 'SK') ? 'selected="selected"' : ''; ?>>Surat Keluar</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9" style="padding-top:8px">
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="optAktif_1" name="Aktif" class="form-control" value="1" required="required" <?php if ($Aktif == "1") {
                                                                                                                              echo " checked=\"checked\"";
                                                                                                                            } ?>>
                        <label for="optAktif_1"> Aktif</label>
                      </div>&nbsp;&nbsp;&nbsp;
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="optAktif_0" name="Aktif" class="form-control" value="0" required="required" <?php if ($Aktif == "0") {
                                                                                                                              echo " checked=\"checked\"";
                                                                                                                            } ?>>
