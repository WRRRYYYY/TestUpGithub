...
class Ktu extends BaseController
{
	public $kode;
	public $page;
	public $tahun;
	...
	function index()
	{
		if (!$this->request->isAJAX()) {
			...
			if ($this->session->get($this->AppModule . "UserID")) {
				if ($this->session->get($this->AppModule . "KodeController") != "Ktu")
...
// 	}
	...
	function ktu0310($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu0311($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu0312($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu0313($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu0801($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080201($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080202($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080203($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080204($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080205($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080206($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080207($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080301($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080302($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080303($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function ktu080304($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080305($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
    ...
    function ktu080307($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
...
//					$data["Periode"] = $data["periode"];
	...
	function ktu080308($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080401($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080402($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080404($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080405($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080501($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080509($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function ktu080601($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function ktu080602($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu080609($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function ktu080701($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function ktu080702($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu081401($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function ktu081403($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			...
			if ($data["MainContentType"] == "frm") {
				...
				$oQueryVerifOleh = $this->bsa_model->get_combo_list($this->AppModule, "ComboAjukanSurat", "'" . $KodeUser . "'");
				$data["oQueryVerifOleh"] = $oQueryVerifOleh;
			...
			$VerifOleh = $_POST["VerifOleh"];
			$VerifCatatan = $_POST["VerifCatatan"];



			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Periode) . "',";
			$Params .= "'" . $this->sql_safe($VerifOleh) . "','" . $this->sql_safe($VerifCatatan) . "',";
			$Params .= "'" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
		}
		$this->load_view($data, $view);
	...
	function ktu081405($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			...
			if ($data["MainContentType"] == "frm") {
				...
				$oQueryAsmanOleh = $this->bsa_model->get_combo_list($this->AppModule, "ComboAjukanSurat", "'" . $KodeUser . "'");
				$data["oQueryAsmanOleh"] = $oQueryAsmanOleh;
			...
			$AsmanOleh = $_POST["AsmanOleh"];
			$AsmanCatatan = $_POST["AsmanCatatan"];



			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Periode) . "',";
			$Params .= "'" . $this->sql_safe($AsmanOleh) . "','" . $this->sql_safe($AsmanCatatan) . "',";
			$Params .= "'" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
		}
		$this->load_view($data, $view);
	...
	function ktu081501($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
