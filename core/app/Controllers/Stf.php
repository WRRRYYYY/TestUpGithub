...
class Stf extends BaseController
{
	public $kode;
	public $page;
	public $tahun;
	...
	function index()
	{
		if (!$this->request->isAJAX()) {
			...
			if ($this->session->get($this->AppModule . "UserID")) {
				if ($this->session->get($this->AppModule . "KodeController") != "Stf")
...
// 	}
	...
	function stf0801($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080201($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080202($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080203($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080204($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080205($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080206($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080207($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080301($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function stf080302($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080303($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function stf080304($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function stf080305($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function stf080401($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080402($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function stf080404($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080501($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080502($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function stf080601($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function stf080602($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080609($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function stf080701($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function stf080702($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
