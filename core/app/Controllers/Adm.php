	...
	function index()
	{
		if (!$this->request->isAJAX()) {
			...
			if ($this->session->get($this->AppModule . "UserID")) {
				if ($this->session->get($this->AppModule . "KodeController") != "Adm")
...
// 	}
	...
	function adm00($data, $view = "app")
	{
		if ($view == "app") {
			...
			//				$data["oQuery"] = $oQuery;
			//
			//				$oQueryInduk = $this->bsa_model->get_combo_list($this->AppModule,"ComboMenu","'" . $KodeUser . "'");	
			//				$data["oQueryInduk"] = $oQueryInduk;
			//			} else {
			$Params .= "'1',''";

			$Pages = 0;
			//				$oQueryListCnt = $this->bsa_model->get_data_list_cnt($this->AppModule,$this->KodeMenu,$Params);
			...
			$Params .= "'" . $this->sql_safe($Aktif) . "','" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
		}
	}

	function adm01($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm0001($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			...
			$Tampil = $_POST["Tampil"];
			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Kode) . "',";
			$Params .= "'" . $this->sql_safe($KodeModul) . "','" . $this->sql_safe($Nama) . "','" . $this->sql_safe($Alias) . "',";
			$Params .= "'" . $this->sql_safe($Induk) . "','" . $this->sql_safe($URLRedirect) . "','" . $this->sql_safe($Ikon) . "',";
			$Params .= "'" . $this->sql_safe($Keterangan) . "','" . $Aktif . "','" . $Tampil . "',";
	...
	function adm0002($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			if ($data["MainContentType"] == "frm") {
				if (isset($data["kode"])) {
					...
					$oQuery = $this->bsa_model->get_data_detail($this->AppModule, $this->KodeView . $this->KodeMenu, $Params);
					$data["oQuery"] = $oQuery;
					$oQueryDtlList = $this->bsa_model->get_detail_list($this->AppModule, $this->KodeView . $this->KodeMenu, "Menu", "'" . $data["kode"] . "'");
					//					$oQueryDtlList02 = $this->bsa_model->get_detail_list($this->AppModule,$this->KodeView.$this->KodeMenu,"Instansi","'".$data["kode"]."'");
				} else {
					$oQueryDtlList = $this->bsa_model->get_detail_list($this->AppModule, $this->KodeView . $this->KodeMenu, "Menu", "''");
					//					$oQueryDtlList02 = $this->bsa_model->get_detail_list($this->AppModule,$this->KodeView.$this->KodeMenu,"Instansi","''");

				}
				$data["oQueryDtlList"] = $oQueryDtlList;
				//				$data["oQueryDtlList02"] = $oQueryDtlList02;
			} else {
				$Params .= "'1',''";
			...
			$KodeModul = $_POST["KodeModul"];
			$Nama = $_POST["Nama"];
			$KodeController = $_POST["KodeController"];
			$KodeView = $_POST["KodeView"];
			$Aktif = $_POST["Aktif"];
			$MenuOpt = "0"; // gak pake MenuOpt // $_POST["opt"]; 
			$Menus = "";
			if (isset($_POST["menus"]))
				$Menus = $_POST["menus"];
			$HakAksesKhusus = $_POST["HakAksesKhusus"];
			$HakAksesTambahan = $_POST["HakAksesTambahan"];
			$InstansiSeries = "";
			if (isset($_POST["desa"]))
				$InstansiSeries = $_POST["desa"];

			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Kode) . "','" . $KodeModul . "',";
			$Params .= "'" . $this->sql_safe($Nama) . "','" . $Aktif . "',";
			$Params .= "'" . $this->sql_safe($KodeController) . "','" . $this->sql_safe($KodeView) . "',";
			$Params .= "'" . $MenuOpt . "','" . $Menus . "',";
			$Params .= "'" . $HakAksesKhusus . "','" . $HakAksesTambahan . "',";
			$Params .= "'" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
		}
	}

	function adm0003($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			if ($data["MainContentType"] == "frm") {
				if (isset($data["kode"])) {
					...
					$oQueryDtlList = $this->bsa_model->get_detail_list($this->AppModule, $this->KodeView . $this->KodeMenu, "Menu", "'" . $KodeRole . "###" . $data["kode"] . "'");
				} else {
					$oQueryDtlList = $this->bsa_model->get_detail_list($this->AppModule, $this->KodeView . $this->KodeMenu, "Menu", "''");
				}
				$data["oQueryDtlList"] = $oQueryDtlList;
				
				$oQueryRole = $this->bsa_model->get_combo_list($this->AppModule, "ComboRole", "'" . $KodeUser . "'");
				$data["oQueryRole"] = $oQueryRole;
				// $oQueryBidang = $this->bsa_model->get_combo_list($this->AppModule, "ComboBidang", "'" . $KodeUser . "'");
				// $data["oQueryBidang"] = $oQueryBidang;
			} else {
				$Params .= "'1',''";
			...
			$this->load_view($data, $view);
		} elseif ($view == "prmdtlst") {
			$Params = "";
			if ($data["ListName"] == "Menu") {
				$KodeUser = $_POST["id"];
				$Params = "'" . $KodeUser . "'";
			} elseif ($data["ListName"] == "Desa") {
				$KodeUser = $_POST["id"];
				$Params = "'" . $KodeUser . "'";
			}
			return $Params;
			...
			$KodeRole = "";
			if (isset($_POST["KodeRole"]))
				$KodeRole = $_POST["KodeRole"];

			$KodeInstansi = "";
			if (isset($_POST["Instansi"]))
				$KodeInstansi = $_POST["Instansi"];

			$Menu_Data = "";
			if (isset($_POST["menus"]))
				$Menu_Data = $_POST["menus"];
			$InstansiSeries = "";
			if (isset($_POST["instansis"]))
				$InstansiSeries = $_POST["instansis"];
			...
			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Kode) . "',";
			$Params .= "'" . $this->sql_safe($Nama) . "','" . $this->sql_safe($JenisKelamin) . "',";
			$Params .= "'" . $this->sql_safe($Password) . "',";
			//	$Params .= "'" . $this->sql_safe($KodeInstansi) ."','" . $this->sql_safe($Handphone) ."',";
			$Params .= "'" . $this->sql_safe($Email) . "','" . $this->sql_safe($Handphone) . "',";
			$Params .= "'" . $Aktif . "','" . $this->sql_safe($Keterangan) . "',";
			$Params .= "'" . $this->sql_safe($KodeRole) . "','" . $this->sql_safe($KodeInstansi) . "',";
			$Params .= "'" . $this->sql_safe($Menu_Data) . "','" . $this->sql_safe($InstansiSeries) . "',";
			//	$Params .= "'" . $HakAksesTambahan ."','" . $Instansi_Data ."','" . $Client_Data ."',";
			$Params .= "'" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
		}
	}

	// Menu-menu Master Umum ############################################

	function adm0310($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			...
			if ($data["MainContentType"] == "frm") {
				...
				$oQueryInduk = $this->bsa_model->get_combo_list($this->AppModule, "ComboStrukturOrg", "'" . $KodeUser . "'");
				$data["oQueryInduk"] = $oQueryInduk;
			} else {
				$Params .= "'1',''";
			...
			$Aktif = $_POST["Aktif"];
			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Kode) . "',";
			$Params .= "'" . $this->sql_safe($Nama) . "','" . $this->sql_safe($Alias) . "',";
			$Params .= "'" . $this->sql_safe($Induk) . "','" . $this->sql_safe($Indeks) . "',";
			$Params .= "'" . $this->sql_safe($Keterangan) . "','" . $Aktif . "',";
			$Params .= "'" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
		}
		//		$this->load_view($data,$view);	
	...
	function adm0311($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			...
			if ($data["MainContentType"] == "frm") {
				...
				$oQueryDesa = $this->bsa_model->get_combo_list($this->AppModule,"ComboDesa","'" . $KodeUser . "',''");	
				$data["oQueryDesa"] = $oQueryDesa;
			...
			$KodeLama = $_POST["KodeLama"];
			// $KodeAlias = $_POST["KodeAlias"];
			$KodeSeri = $_POST["KodeSeri"];
			$Nama = $_POST["Nama"];
			$NIK = $_POST["NIK"];
			$JenisKelamin = $_POST["JenisKelamin"];
			...
			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($KodeSeri) . "',";
			$Params .= "'" . $this->sql_safe($Nama) . "','" . $this->sql_safe($NIK) . "',";
			$Params .= "'" . $this->sql_safe($JenisKelamin) . "','" . $this->sql_safe($TanggalLahir) . "',";
			$Params .= "'" . $this->sql_safe($Alamat) . "','" . $this->sql_safe($Desa) . "',";
			$Params .= "'" . $this->sql_safe($Handphone) . "','" . $this->sql_safe($Email) . "',";
			$Params .= "'" . $this->sql_safe($Keterangan) . "',";
			$Params .= "'" . $Aktif . "','" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
		}
	}
	
	function adm0312($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			if (!isset($data["periode"]))
				$data["periode"] = $this->RenstraAktif; //date("Y");
			$Params .= "'" . $data["periode"] . "',";
			if ($data["MainContentType"] == "frm") {
				if (isset($data["kode"])) {
					$Params .= "'" . $data["kode"] . "',0";
				...
				// $oQueryStruktur = $this->bsa_model->get_combo_list($this->AppModule, "ComboStrukturOrg", "'" . $KodeUser . "'");
				// $data["oQueryStruktur"] = $oQueryStruktur;
				$oQueryPegawai = $this->bsa_model->get_combo_list($this->AppModule, "ComboPegawai", "'" . $KodeUser . "'");
				$data["oQueryPegawai"] = $oQueryPegawai;
			} else {
			...
			$oQueryPeriode = $this->bsa_model->get_combo_list($this->AppModule, "ComboRenstra", "'" . $KodeUser . "'");
			$data["oQueryPeriode"] = $oQueryPeriode;
		} elseif ($view == "prmsave") {
			$KodeLama = $_POST["KodeLama"];
			$KodePeriode = $_POST["KodePeriode"];
			$KodeStruktur = $_POST["KodeStruktur"];

			$KodePegawai = $_POST["KodePegawai"]; 
			$Keterangan = $_POST["Keterangan"];	

			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($KodePeriode) . "',";
			$Params .= "'" . $this->sql_safe($KodeStruktur) . "','" . $this->sql_safe($KodePegawai) . "',";
			$Params .= "'" . $this->sql_safe($Keterangan) . "',";
	...
	function adm0313($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			...
			$Params .= "'" . $Aktif . "','" . $this->sql_safe($Keterangan) . "',";
			$Params .= "'" . $this->sql_safe($KodeRole) . "','" . $this->sql_safe($KodeInstansi) . "',";
			$Params .= "'" . $this->sql_safe($KodePosisi) ."','" . $this->sql_safe($KodePerson) ."',";
			$Params .= "'" . $this->sql_safe($Menu_Data) . "','" . $this->sql_safe($InstansiSeries) . "',";
			//	$Params .= "'" . $HakAksesTambahan ."','" . $Instansi_Data ."','" . $Client_Data ."',";
			$Params .= "'" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
	...
	function adm0801($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080201($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			...
			$Aktif = $_POST["Aktif"];
			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Kode) . "',";
			$Params .= "'" . $this->sql_safe($Nama) . "','" . $this->sql_safe($Kelompok) . "','" . $this->sql_safe($Keterangan) . "',";
	...
	function adm080202($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080203($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080204($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080205($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080206($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080207($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080208($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			...
			$Aktif = $_POST["Aktif"];
			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Kode) . "',";
			$Params .= "'" . $this->sql_safe($Nama) . "','" . $this->sql_safe($Isi) . "',";
			$Params .= "'" . $this->sql_safe($Aktif) . "',";
			$Params .= "'" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
		}
	...
	function adm080209($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			...
			$Seq = $_POST["Seq"];
			$Nama = $_POST["Nama"];
			$Teks = $this->get_body_string($_POST["Teks"]);
			$Keterangan = $_POST["Keterangan"];
			$Aktif = $_POST["Aktif"];
			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Kode) . "',";
			$Params .= "'" . $this->sql_safe($Jenis) . "','" . $this->sql_safe($Seq) . "',";
			$Params .= "'" . $this->sql_safe($Nama) . "','" . $this->sql_safe($Teks) . "',";
			$Params .= "'" . $this->sql_safe($Keterangan) . "','" . $Aktif . "',";
			$Params .= "'" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
		}
	...
	function adm080301($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function adm080302($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080303($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function adm080304($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function adm080305($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
    ...
    function adm080307($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
			...
			if ($data["MainContentType"] == "frm") {
				if (isset($data["kode"])) {
					...
					$oQueryList = $this->bsa_model->get_detail_list($this->AppModule, $this->KodeView . $this->KodeMenu, "", "'" . $data["kode"] . "'");
					$data["oQueryList"] = $oQueryList;
					//echo $oQueryDtlList; die();

					// $oQueryPemohon = $this->bsa_model->get_combo_list($this->AppModule, "ComboKategoriPemohon", "'" . $KodeUser . "'");
				    // $data["oQueryPemohon"] = $oQueryPemohon;
				}
				$this->load_view($data, $view);
				...
				if($data["ExtName"]=="Add") {
					...
					$oQuery = $this->bsa_model->get_data_detail_ext($this->AppModule,$this->KodeView.$this->KodeMenu,$data["ExtName"],$Params);
					$data["oQuery"] = $oQuery;
					// echo $oQuery; die();
					$Wilayah = "33";
					// if(isset($_POST["wil"])) $Wilayah = $_POST["wil"];
					
					$oQueryKabupaten = $this->bsa_model->get_combo_list($this->AppModule,"ComboKabupaten","'" . $KodeUser . "','".$Wilayah."'");	
					$data["oQueryKabupaten"] = $oQueryKabupaten;
					$oQueryPemohon = $this->bsa_model->get_combo_list($this->AppModule, "ComboKategoriPemohon", "'" . $KodeUser . "'");
				    $data["oQueryPemohon"] = $oQueryPemohon;
					$oQueryStruktur = $this->bsa_model->get_combo_list($this->AppModule, "ComboStrukturOrg", "'" . $KodeUser . "'");
					$data["oQueryStruktur"] = $oQueryStruktur;
						
				} elseif($data["ExtName"]=="Upload") {
//					$data["Periode"] = $data["periode"];
			...
			$Nama = $_POST["Nama"];
			$NIK = $_POST["NIK"];
			$GunaPengajuan = $_POST["GunaPengajuan"];
			$Alamat = $_POST["Alamat"];

			$Handphone = $_POST["Handphone"];
			$Nominal =	$_POST["NominalPengajuan"];
			$Rekomendasi  = $_POST["Rekomendasi"];
			$Keterangan = $_POST["Keterangan"];
			$DtlTanggal  = $_POST["TanggalProposal"];
			$Realisasi  = $_POST["Realisasi"];
			$RealTanggal  = $_POST["RealTanggal"];

			$ForceSave  = $_POST["ForceSave"];

			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Periode) . "',";
			$Params .= "'" . $this->sql_safe($DtlSeq) . "','" . $this->sql_safe($Kategori) . "',";
			$Params .= "'" . $this->sql_safe($Kabupaten) . "','" . $this->sql_safe($KategoriPemohon) . "',";
			$Params .= "'" . $this->sql_safe($Nama) . "','" . $this->sql_safe($NIK) . "',";

			$Params .= "'" . $this->sql_safe($Alamat) . "','" . $this->sql_safe($Handphone) . "',";
			$Params .= "'" . $this->sql_safe($GunaPengajuan) . "','" . $this->sql_safe($Nominal) . "',";
			$Params .= "'" . $this->sql_safe($Rekomendasi) . "','" . $this->sql_safe($Keterangan) . "',";
			$Params .= "'" . $this->sql_safe($DtlTanggal) . "',";
			$Params .= "'" . $this->sql_safe($Realisasi) . "','" . $this->sql_safe($RealTanggal) . "',";
			$Params .= "'" . $this->sql_safe($ForceSave) . "',";
	...
	function adm080401($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080402($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080404($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080405($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080501($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080502($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function adm080601($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function adm080602($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function adm080609($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
