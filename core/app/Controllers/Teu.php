...
class Teu extends BaseController
{
	public $kode;
	public $page;
	public $tahun;
	...
	function index()
	{
		if (!$this->request->isAJAX()) {
			...
			if ($this->session->get($this->AppModule . "UserID")) {
				if ($this->session->get($this->AppModule . "KodeController") != "Teu")
...
// 	}
	...
	function teu0801($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080201($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080202($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080203($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080204($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080205($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080206($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080207($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080208($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080209($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080301($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function teu080302($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080303($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function teu080304($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function teu080305($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
    ...
    function teu080307($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
...
//					$data["Periode"] = $data["periode"];
	...
	function teu080308($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID"); 
			$Params = "'" . $KodeUser . "',";
	...
	function teu080401($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080402($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080403($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
			...
			if ($data["MainContentType"] == "frm") {
				...
				if($data["ExtName"]=="GetNumber") {
					// if(isset($_POST["id"])) 
						$Params .= "'".$_POST["id"]."','".$_POST["tgl"]."'" ;
					// else $Params .= "''";
					$oQuery = $this->bsa_model->get_data_detail_ext($this->AppModule,$this->KodeView.$this->KodeMenu,"CekAutoNumber",$Params);
					$data["oQuery"] = $oQuery;
					$oQueryList = $this->bsa_model->get_detail_list($this->AppModule, $this->KodeView . $this->KodeMenu, "", $Params);
					$data["oQueryList"] = $oQueryList;
...
//					$data["Periode"] = $data["periode"];
			...
			$Params = "'" . $this->sql_safe($KodeLama) . "','" . $this->sql_safe($Periode) . "',";
			$Params .= "'" . $this->sql_safe($TanggalSurat) . "','" . $this->sql_safe($NomorSurat) . "',";
			$Params .= "'" . $this->sql_safe($Lampiran) . "','" . $this->sql_safe($Sisip) . "',";
			$Params .= "'" . $this->sql_safe($this->session->get($this->AppModule . "UserID")) . "'";
			return $Params;
		}
	}				
	
	function teu080405($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080404($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080501($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080502($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function teu080601($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function teu080602($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080609($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu080701($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
    ...
    function teu080702($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu081403($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
	...
	function teu081405($data, $view = "app")
	{
		if ($view == "app") {
			$KodeUser = $this->session->get($this->AppModule . "UserID");
			$Params = "'" . $KodeUser . "',";
